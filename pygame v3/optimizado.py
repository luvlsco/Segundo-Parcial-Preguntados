...
def ventana_configuracion():
    ...
    ventana_configuracion = pygame.image.load("assets/images icon/fondo_configurar.png") 
    ventana_configuracion = pygame.transform.scale(ventana_configuracion,(800, 600))
    ventana.blit(ventana_configuracion, (0, 0))
...
def ventana_agregar_pregunta():
    ...
    ventana_pregunta = pygame.image.load("assets/images icon/fondo_agregar_pregunta.png")
...
def ventana_agregar_preguntas():
    ...
    fondo = pygame.image.load("assets/images icon/fondo_agregar_pregunta.png")
